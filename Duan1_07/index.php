...
// Route::post('/pays', 'App\Controllers\Client\CheckoutController@pay');
...
Route::get('/address/user', 'App\Controllers\Client\MyAccountController@address');
Route::post('/createOrders', 'App\Controllers\Client\PayController@createOrder');

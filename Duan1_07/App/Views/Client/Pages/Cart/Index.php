                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="col-md-4 d-flex align-items-center">
                                                <div class="form-check me-3">
                                                    ...
                                                    <input type="hidden" name="name[]" value="<?= htmlspecialchars($cart['data']['product_name']) ?>" />
                                                    <input type="hidden" name="price[]" value="<?= $cart['data']['price'] - $cart['data']['discount_price'] ?>" />
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Màu sắc: <?= $cart['color'] ?? 'Không có màu sắc' ?></p>
                                                    <p class="card-text">Kích thước: <?= $cart['size'] ?? 'Không có' ?></p>
